...
function ToastItem({ toast, onClose }: { toast: Toast; onClose: () => void }) {
  ...
  return (
    <div
      role="status"
      className={clsx(
        "pointer-events-auto relative flex gap-3 overflow-hidden rounded-xl border border-zinc-200 bg-white p-3 pr-8 shadow-soft transition-all dark:border-zinc-700/50 dark:bg-[#14171C]",
